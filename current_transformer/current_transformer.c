...
void init_adc() {
    ...
    adc1_config_channel_atten(channel, atten);          // Set the attenuation
    adc1_config_channel_atten(ADC_CHANNEL_7, atten);    // Configure the second channel as well (needed for AC current measurements)
